...
MODEL_PATH = "gesture_cnn_model_version1.h5"
IMAGE_SIZE = 128
...
while True:
    ...
    #Error Analysis: I noticed that for the open palm gesture, the two fingers and three fingers gesture were detected sometimes by model
    if gesture == "OPEN_PALM" and confidence < 0.7:
        gesture = "Uncertain"
